      ...
      <form class="row g-3 align-items-end" method="get" action="employer_candidates.php" aria-label="Candidate salary filter form">
        ...
        <div class="col-6 col-md-2">
          ...
          <select class="form-select form-select-sm" id="period" name="period">
            <?php $periods=['monthly'=>'Monthly','yearly'=>'Yearly','hourly'=>'Hourly']; foreach ($periods as $k=>$lbl): ?>
...
<style>
  #candidateResults .card { transition: box-shadow .25s ease, transform .25s ease; }
  #candidateResults .card:hover { box-shadow:0 6px 20px -4px rgba(0,0,0,.25); transform:translateY(-2px); }
</style>
