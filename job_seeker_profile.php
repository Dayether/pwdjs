                ...
                <div class="jsp-summary-inner p-4">
                        ...
                        <div class="flex-grow-1" style="min-width:240px;">
                            ...
                            <div class="jsp-meta-chips mb-2">
                                ...
                                <?php if (!empty($target->region) || !empty($target->province) || !empty($target->city)): ?>
                                    <span class="jsp-chip"><i class="bi bi-geo" aria-hidden="true"></i><?php $parts = array_filter([$target->city, $target->province, $target->region]);
                                                                                                        echo htmlspecialchars(implode(', ', $parts)); ?></span>
                                <?php endif; ?>
                    ...
                    <div class="data-grid">
                        <div class="data-item">
                            ...
                            <div class="value"><?php echo htmlspecialchars($target->email); ?></div>
                        </div>
                        <div class="data-item">
                            <div class="label">Disability</div>
                            <div class="value"><?php echo htmlspecialchars($disabilityLabel); ?></div>
                        </div>
                        <?php if (!empty($target->date_of_birth)): ?>
                            <div class="data-item">
                                <div class="label">Age</div>
                                <div class="value"><?php $dobTs = strtotime($target->date_of_birth);
                                                    if ($dobTs) {
                        ...
                        <?php endif; ?>
                        <?php if (!empty($target->phone)): ?><div class="data-item">
                                <div class="label">Phone</div>
                                <div class="value"><?php echo htmlspecialchars($target->phone); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->disability_type)): ?><div class="data-item">
                                <div class="label">Disability Type</div>
                                <div class="value"><?php echo htmlspecialchars($target->disability_type); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->disability_severity)): ?><div class="data-item">
                                <div class="label">Severity</div>
                                <div class="value"><?php echo htmlspecialchars($target->disability_severity); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->assistive_devices)): ?><div class="data-item">
                                <div class="label">Assistive Devices</div>
                                <div class="value"><?php echo htmlspecialchars($target->assistive_devices); ?></div>
                            </div><?php endif; ?>
                        <div class="data-item">
                            <div class="label">Education</div>
                            <div class="value"><?php echo htmlspecialchars($educationLabel); ?></div>
                        </div>
                        <div class="data-item">
                            <div class="label">Experience</div>
                            <div class="value"><?php echo htmlspecialchars($experienceLabel); ?></div>
                        </div>
                        <?php if (!empty($target->gender)): ?><div class="data-item">
                                <div class="label">Gender</div>
                                <div class="value"><?php echo htmlspecialchars($target->gender); ?></div>
                            </div><?php endif; ?>
                        <?php if ($resumeSafe): ?><div class="data-item">
                                <div class="label">Resume</div>
                                <div class="value"><a href="<?php echo htmlspecialchars($resumeSafe); ?>" target="_blank" class="text-decoration-none"><i class="bi bi-file-earmark-pdf me-1" aria-hidden="true"></i>View</a></div>
                            </div><?php endif; ?>
                        <?php if ($videoSafe): ?><div class="data-item">
                                <div class="label">Video Intro</div>
                                <div class="value"><a href="<?php echo htmlspecialchars($videoSafe); ?>" target="_blank" class="text-decoration-none"><i class="bi bi-camera-video me-1" aria-hidden="true"></i>Watch</a></div>
                            </div><?php endif; ?>
                        <?php
                        $salParts = [];
                        ...
                        ?>
                        <?php if ($salaryDisp): ?><div class="data-item">
                                <div class="label">Expected Salary</div>
                                <div class="value"><?php echo htmlspecialchars($salaryDisp); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->interests)): ?><div class="data-item">
                                <div class="label">Interests</div>
                                <div class="value"><?php echo nl2br(htmlspecialchars($target->interests)); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->accessibility_preferences)): ?><div class="data-item">
                                <div class="label">Accessibility</div>
                                <div class="value"><?php echo htmlspecialchars($target->accessibility_preferences); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->preferred_work_setup)): ?><div class="data-item">
                                <div class="label">Work Setup</div>
                                <div class="value"><?php echo htmlspecialchars($target->preferred_work_setup); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($target->preferred_location)): ?><div class="data-item">
                                <div class="label">Preferred Location</div>
                                <div class="value"><?php echo htmlspecialchars($target->preferred_location); ?></div>
                            </div><?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-7">
            ...
            <div class="section-card applications-table-wrapper fade-up fade-delay-3" role="region" aria-label="Applications list">
                <div class="section-card-header mb-2">
                    <div class="d-flex align-items-center"><span class="section-icon me-2"><i class="bi bi-send" aria-hidden="true"></i></span>
            ...
            <div class="section-card p-4 mt-4 fade-up fade-delay-4" role="region" aria-label="Work experience">
                <div class="section-card-header">
                    <div class="d-flex align-items-center"><span class="section-icon me-2"><i class="bi bi-briefcase" aria-hidden="true"></i></span>
                        <h2 class="h6 fw-semibold mb-0">Work Experience</h2>
                    </div>
                </div>
                <?php if (!$experiences): ?>
            ...
            <div class="section-card p-4 mt-4 fade-up fade-delay-5" role="region" aria-label="Certifications">
                <div class="section-card-header">
                    <div class="d-flex align-items-center"><span class="section-icon me-2"><i class="bi bi-patch-check" aria-hidden="true"></i></span>
                        <h2 class="h6 fw-semibold mb-0">Certifications</h2>
                    </div>
                </div>
                <?php if (!$certs): ?>
