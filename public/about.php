...
.about-hero.about-hero-img {
  background: linear-gradient(135deg, rgba(13,110,253,.88), rgba(102,16,242,.88)), var(--hero-img, radial-gradient(circle at 40% 40%, #0d6efd, #6610f2));
  background-size: cover; background-position:center; background-repeat:no-repeat;
}
.about-hero.about-hero-img::before { display:none; }
.about-hero.about-hero-img::after { opacity:.15; }
/* Text shadow for readability when image present */
.about-hero.about-hero-img h1, .about-hero.about-hero-img p, .about-hero.about-hero-img .btn-modern { text-shadow:0 2px 4px rgba(0,0,0,.3); }
/* Height control with clamp */
.about-hero { min-height: clamp(420px, 58vh, 620px); }
/* Fullscreen variant: occupy entire viewport so next section is hidden until scroll */
.about-hero.hero-full { min-height: 100vh; }
/* Overlay strength variants */
.about-hero.overlay-light.about-hero-img { background: linear-gradient(135deg, rgba(13,110,253,.55), rgba(102,16,242,.55)), var(--hero-img) center/cover no-repeat; }
.about-hero.overlay-medium.about-hero-img { background: linear-gradient(135deg, rgba(13,110,253,.72), rgba(102,16,242,.72)), var(--hero-img) center/cover no-repeat; }
.about-hero.overlay-strong.about-hero-img { background: linear-gradient(135deg, rgba(13,110,253,.90), rgba(102,16,242,.90)), var(--hero-img) center/cover no-repeat; }
...
@media (max-width: 767.98px){
  .about-hero.about-hero-img { background-position: center top; }
}
/* Wave divider at bottom */
.about-hero .hero-inner { position:relative; z-index:3; }
@media (min-width: 992px){
  .about-hero { border-radius:0; }
}
...
.about-hero::before {
  ...
  background: 
    ...
    radial-gradient(circle at 30% 80%, rgba(102,16,242,.2), transparent 70%);
...
.about-hero .btn-modern:hover, .about-hero .btn-modern:focus { 
  background:#fff; 
  color:#10325a; 
  border-color:#fff; 
...
.about-hero .btn-modern:not(.active) { opacity:.9; }
.about-hero .btn-modern:not(.active):hover { opacity:1; }
