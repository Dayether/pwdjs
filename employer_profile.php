...
<style>
    ...
    .emp-metric {
        ...
        border-radius: 1rem;
        box-shadow: 0 10px 28px -12px rgba(13, 110, 253, .28), 0 4px 14px rgba(0, 0, 0, .05);
        min-width: 150px;
        flex: 0 0 auto;
        overflow: hidden;
        display: flex;
    ...
    .emp-metric::before {
        ...
        position: absolute;
        inset: 0;
        background: radial-gradient(circle at 18% 25%, rgba(255, 193, 7, .25), transparent 55%), radial-gradient(circle at 82% 15%, rgba(102, 16, 242, .25), transparent 60%);
    ...
    @media (prefers-reduced-motion: no-preference) {
        ...
        .emp-metric:hover {
            ...
            box-shadow: 0 16px 34px -14px rgba(13, 110, 253, .45), 0 6px 20px rgba(0, 0, 0, .08);
        }
    }
    ...
    .emp-hero-left .ep-avatar {
        width: 110px;
        height: 110px;
        margin: 0 auto;
    }

    .emp-hero-left .emp-actions {
        justify-content: center;
    }
    ...
    .ep-jobs-card {
        ...
        box-shadow: 0 10px 30px -12px rgba(13, 110, 253, .25), 0 4px 14px rgba(0, 0, 0, .06);
        overflow: hidden;
    }
    ...
    .ep-jobs-card::before {
        ...
        inset: 0;
        pointer-events: none;
        background: radial-gradient(circle at 14% 20%, rgba(255, 193, 7, .2), transparent 60%), radial-gradient(circle at 85% 15%, rgba(102, 16, 242, .18), transparent 60%);
        mix-blend-mode: overlay;
        opacity: .55;
    }
    ...
    .ep-avatar {
        ...
        overflow: hidden;
        flex-shrink: 0;
        box-shadow: 0 6px 18px -6px rgba(13, 110, 253, .45);
    ...
    .ep-badge-status.approved {
        background: #e4f9ed;
        color: #0b6a32;
    }

    .ep-badge-status.suspended {
        background: #ffe8e3;
        color: #7d2d11;
    }

    .ep-badge-status.rejected {
        background: #f1f3f5;
        color: #4d5963;
    }

    .ep-badge-status.pending {
        background: #fff6e0;
        color: #7a4b00;
    }
        ...
        <div class="emp-hero-grid">
            ...
            <div class="emp-hero-right min-w-0">
                <div class="emp-metrics name-inline fade-up fade-delay-2" aria-label="Quick statistics and employer name">
                    ...
                    <?php $openCt = count(array_filter($jobs, fn($j) => $j['status'] === 'Open'));
                    $closedCt = count(array_filter($jobs, fn($j) => $j['status'] === 'Closed')); ?>
            ...
            <div class="ep-left-card h-100">
                ...
                <dl class="ep-details-dl">
                    ...
                    <?php if ($canSeePrivate && $employer->employer_status): ?>
                        <dt>Status</dt>
                        <dd>
                            <?php $st = $employer->employer_status;
                            $cls = strtolower($st); ?>
