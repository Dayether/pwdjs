...
?>
<?php if (!empty($_SESSION['flash'])): $flashes = Helpers::getFlashes();
    foreach ($flashes as $k => $m): $t = Helpers::mapFlashType($k); ?>
        ...
        <div class="profile-progress-card mb-4">
            <div class="profile-progress-inner p-4">
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <a class="btn btn-gradient" href="<?php echo rtrim(BASE_URL, '/'); ?>/"><i class="bi bi-search me-1" aria-hidden="true"></i><span>Find Jobs</span></a>
