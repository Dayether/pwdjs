...
<div class="admin-layout">
    <?php $currentPage = 'admin_tasks_log.php';
    ...
    <div class="admin-main">
            ...
            <div class="table-responsive">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        <?php if (!$rows): ?>
                            <tr>
                                <td colspan="7" class="text-center text-secondary">No logs found.</td>
                            </tr>
        ...
        if ($pages > 1): ?>
            <nav aria-label="Pagination">
                <ul class="pagination">
                    <?php $qs = $_GET;
                    for ($p = 1; $p <= $pages; $p++): $qs['p'] = $p;
                        $url = 'admin_tasks_log.php?' . http_build_query($qs); ?>
