...
<style>
    ...
    :root {
        --terms-accent: #2563eb;
        --terms-accent-rgb: 37 99 235;
        --terms-gradient: linear-gradient(135deg, #0d6efd 0%, #2563eb 55%, #6366f1 100%);
        --terms-border: #e2e8f0;
        --terms-bg-soft: #f5f7fb;
        --terms-radius-lg: 1rem;
        --terms-radius-md: .85rem;
        --terms-radius-sm: .6rem;
    }

    @media (prefers-color-scheme: dark) {
        :root {
            --terms-border: #1f2937;
            --terms-bg-soft: #111827;
        }
    }
    ...
    .terms-progress {
        ...
        box-shadow: 0 0 0 1px rgba(255, 255, 255, .15), 0 1px 3px rgba(0, 0, 0, .15);
    }
    ...
    .terms-sidebar::-webkit-scrollbar-thumb {
        background: rgba(var(--terms-accent-rgb)/.35);
        border-radius: 4px;
    }
    ...
    .terms-hero {
        ...
        position: relative;
        overflow: hidden;
        box-shadow: 0 10px 25px -10px rgba(var(--terms-accent-rgb)/.55), 0 4px 12px -4px rgba(0, 0, 0, .25);
    }
    ...
    .terms-hero::before {
        width: 300px;
        height: 300px;
        background: radial-gradient(circle at 30% 40%, #fff, transparent 70%);
        left: -70px;
        top: -80px;
    }
    ...
    .terms-hero::after {
        width: 360px;
        height: 360px;
        background: radial-gradient(circle at 70% 55%, #fff, transparent 70%);
        right: -80px;
        bottom: -120px;
    }
    ...
    .terms-section:not(:first-of-type)::before {
        content: "";
        position: absolute;
        left: 0;
        right: 0;
    ...
    .terms-section:nth-of-type(n+4) .terms-section-title .number {
        background: #3b82f61a;
        color: #1d4ed8;
        box-shadow: none;
    }
    ...
    .terms-section:hover .terms-anchor-btn {
        opacity: 1;
    }
    ...
    .terms-anchor-btn:focus-visible {
        outline: 2px solid #3b82f6;
        outline-offset: 2px;
        opacity: 1;
    }
    ...
    .terms-section.fade-in {
        ...
        animation: fadeInTerms .55s forwards ease var(--fade-delay);
    }
                ...
                <div class="terms-content-flow">
                    ...
                    <section id="acceptance" class="terms-section section-anchor fade-in" style="--fade-delay:.05s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Acceptance</h2><button class="terms-anchor-btn" data-anchor="#acceptance" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="roles" class="terms-section section-anchor fade-in" style="--fade-delay:.1s;">
                        <div class="terms-section-title">
                            ...
                            <h2>User Roles</h2><button class="terms-anchor-btn" data-anchor="#roles" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="eligibility" class="terms-section section-anchor fade-in" style="--fade-delay:.15s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Eligibility</h2><button class="terms-anchor-btn" data-anchor="#eligibility" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="accounts" class="terms-section section-anchor fade-in" style="--fade-delay:.2s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Accounts & Security</h2><button class="terms-anchor-btn" data-anchor="#accounts" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="employer-verification" class="terms-section section-anchor fade-in" style="--fade-delay:.25s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Employer Verification</h2><button class="terms-anchor-btn" data-anchor="#employer-verification" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="job-posting" class="terms-section section-anchor fade-in" style="--fade-delay:.3s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Job Posting Rules</h2><button class="terms-anchor-btn" data-anchor="#job-posting" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                        <div class="terms-text">
                            <ul>
                    ...
                    <section id="applications" class="terms-section section-anchor fade-in" style="--fade-delay:.35s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Applications & Fairness</h2><button class="terms-anchor-btn" data-anchor="#applications" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="reports" class="terms-section section-anchor fade-in" style="--fade-delay:.4s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Reporting & Moderation</h2><button class="terms-anchor-btn" data-anchor="#reports" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="prohibited" class="terms-section section-anchor fade-in" style="--fade-delay:.45s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Prohibited Conduct</h2><button class="terms-anchor-btn" data-anchor="#prohibited" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                        <div class="terms-text">
                            <ul>
                    ...
                    <section id="intellectual-property" class="terms-section section-anchor fade-in" style="--fade-delay:.5s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Intellectual Property</h2><button class="terms-anchor-btn" data-anchor="#intellectual-property" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="license" class="terms-section section-anchor fade-in" style="--fade-delay:.55s;">
                        <div class="terms-section-title">
                            ...
                            <h2>License to Platform</h2><button class="terms-anchor-btn" data-anchor="#license" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="disclaimers" class="terms-section section-anchor fade-in" style="--fade-delay:.6s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Disclaimers</h2><button class="terms-anchor-btn" data-anchor="#disclaimers" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="liability" class="terms-section section-anchor fade-in" style="--fade-delay:.65s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Limitation of Liability</h2><button class="terms-anchor-btn" data-anchor="#liability" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="termination" class="terms-section section-anchor fade-in" style="--fade-delay:.7s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Termination</h2><button class="terms-anchor-btn" data-anchor="#termination" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
                    ...
                    <section id="changes" class="terms-section section-anchor fade-in" style="--fade-delay:.75s;">
                        <div class="terms-section-title">
                            ...
                            <h2>Changes / Contact</h2><button class="terms-anchor-btn" data-anchor="#changes" aria-label="Copy link" title="Copy link">🔗</button>
                        </div>
    ...
    (function() {
        ...
        document.querySelectorAll('.terms-anchor-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                clearTimeout(window.__termsToastTimer);
                window.__termsToastTimer = setTimeout(() => toast.classList.remove('show'), 1800);
            });
        });
