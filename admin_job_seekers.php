...
<div class="admin-layout">
    ...
    <div class="admin-main">
        <style>
            ...
            .js-filters .search-box {
                flex: 1 1 260px;
                position: relative
            }

            .js-filters .search-box input {
                background: #101b2b;
            ...
            .js-filters button.reset-btn:hover {
                background: #213249;
                color: #fff
            }
            ...
            table.seekers-table tbody tr:last-child td {
                border-bottom: none
            }

            table.seekers-table tbody tr {
                transition: .2s
            }

            table.seekers-table tbody tr:hover {
            ...
            @media (max-width:880px) {
                ...
                table.seekers-table,
                table.seekers-table thead,
                table.seekers-table tbody,
                table.seekers-table th,
                table.seekers-table td,
                table.seekers-table tr {
                    display: block
                }
                ...
                table.seekers-table tbody td.actions {
                    margin-top: .4rem
                }
            }
        ...
        <div class="seekers-wrapper fade-in" id="seekersWrapper">
            <table class="seekers-table" id="seekersTable">
                ...
                <tbody>
                    <?php if (!$rows): ?>
                        <tr>
                            <td colspan="8" class="empty-state">No job seekers found.</td>
                        </tr>
    ...
    <script>
        ...
        chips?.addEventListener('click', e => {
            const c = e.target.closest('.js-chip');
            if (!c) return;
            [...chips.querySelectorAll('.js-chip')].forEach(x => x.classList.remove('active'));
            c.classList.add('active');
            statusSelect.value = c.getAttribute('data-filter') || '';
            apply();
        });
        ...
        function syncChip() {
            ...
            [...chips.querySelectorAll('.js-chip')].forEach(ch => {
                ch.classList.toggle('active', (ch.getAttribute('data-filter') || '') === v);
            });
        }

        // Sort
        document.querySelectorAll('#seekersTable thead th[data-sort]').forEach(th => {
                ...
                arr.sort((a, b) => {
                    const get = (row) => {
                        switch (key) {
                            ...
                            case 'acct':
                                return row.getAttribute('data-acct') || '';
                            default:
