    ...
    <div class="admin-main">
        ...
        <style>
            ...
            .emp-edit-card {
                ...
                box-shadow: 0 14px 40px -12px rgba(13, 110, 253, .30), 0 6px 18px rgba(0, 0, 0, .06);
                padding: 1.6rem 1.6rem 2rem;
                position: relative;
                overflow: hidden;
            }

            .emp-edit-card::before {
                content: "";
                position: absolute;
                inset: 0;
                background: radial-gradient(circle at 14% 20%, rgba(255, 193, 7, .22), transparent 60%), radial-gradient(circle at 85% 15%, rgba(102, 16, 242, .20), transparent 60%);
            ...
            .avatar-upload-box {
                ...
                box-shadow: 0 8px 24px -10px rgba(13, 110, 253, .18), 0 4px 12px rgba(0, 0, 0, .05);
            }
            ...
            .avatar-preview {
                ...
                box-shadow: 0 6px 18px -8px rgba(13, 110, 253, .4);
            }
            ...
            .divider-soft {
                height: 1px;
                background: linear-gradient(90deg, #dde3e9, #f7f9fb);
            ...
            @media (max-width:575.98px) {
                .emp-edit-card {
                    padding: 1.15rem 1.05rem 1.5rem;
                }
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (ownerInput && displayMirror) {
                    const sync = () => {
                        displayMirror.value = ownerInput.value;
                    };
