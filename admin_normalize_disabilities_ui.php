...
<div class="admin-layout">
    <?php $currentPage = 'admin_normalize_disabilities_ui.php';
...
<script>
    ...
    async function loadLast() {
        try {
            const r = await fetch('admin_normalize_disabilities.php?action=last', {
    ...
    async function preview() {
        ...
        uBody.innerHTML = '';
        jBody.innerHTML = '';
        const r = await fetch('admin_normalize_disabilities.php?action=dry-run', {
            credentials: 'same-origin'
        });
        const data = await r.json();
