...
<div class="admin-layout">
    ...
    <div class="admin-main">
        ...
        <style>
            ...
            .admin-page-header .btn-outline-light {
            ...
            .admin-page-header .btn-outline-light:hover {
        ...
        foreach ($___fl as $k => $msg): $type = ($k === 'error' || $k === 'danger') ? 'danger' : (($k === 'success') ? 'success' : 'info'); ?>
        ...
        <style>
            .security-note {
                ...
                align-items: flex-start;
                gap: .9rem;
                background: linear-gradient(135deg, #101d2e, #0d1624);
            ...
            .security-note .icon-wrap i {
                font-size: 1.15rem;
                color: #6cb2ff;
                filter: drop-shadow(0 2px 6px rgba(108, 178, 255, .4));
            }
