...
<nav class="navbar navbar-expand-lg navbar-themed<?php echo $isIndex ? '' : ' sticky-top'; ?>">
    <div class="container-fluid px-3 px-xl-5">
        ...
        ?>
        <a class="navbar-brand d-flex align-items-center gap-2 <?php echo nav_active('about.php', $currentPage); ?>" href="<?php echo rtrim(BASE_URL, '/'); ?>/about" aria-label="PWD Portal Home">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 align-items-lg-center">
                ...
                <?php if (!$loggedIn): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo nav_active('register.php', $currentPage); ?>" href="register.php">
...
<style>
    ...
    .navbar-themed .btn-light.btn-sm i {
        font-size: 1rem;
    }

    /* Post Job button */
    .navbar-themed .btn-accent.btn-sm {
        box-shadow: 0 4px 16px -4px rgba(255, 193, 7, .45);
        padding: 0.6rem 1.5rem;
        font-weight: 600;
        border-radius: 8px;
        transition: all 0.2s ease;
    ...
    .navbar-themed .btn-accent.btn-sm:hover {
        transform: translateY(-2px);
        box-shadow: 0 6px 20px -4px rgba(255, 193, 7, .6);
    }

    /* Profile dropdown */
    .navbar-themed .navbar-brand span.rounded-circle {
        box-shadow: 0 0 0 2px rgba(255, 255, 255, .4);
    }

    .navbar-themed .nav-link.dropdown-toggle {
        padding: 0.4rem 1rem;
    }

    /* Spacing adjustments for navbar items */
    .navbar-themed .navbar-nav.me-auto {
        margin-right: auto !important;
    }

    .navbar-themed .navbar-nav:last-child {
        gap: 0.75rem;
    }

    .navbar-themed .navbar-nav:last-child .nav-item {
        display: flex;
        align-items: center;
    }
    ...
    .navbar .dropdown-menu .dropdown-item:hover {
        background: linear-gradient(90deg, #eef5ff, #e6f0ff);
    }
