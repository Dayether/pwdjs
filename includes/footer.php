      ...
      <style>
        ...
        .footer-cta-wrap { position: relative; z-index: 2; }
        .footer-cta {
        ...
        .footer-cta h3 { margin: 0; font-weight: 800; letter-spacing: .2px; }
        .footer-cta p { margin: .25rem 0 0; opacity: .9; }
        .footer-cta .cta-text { display: grid; gap: .15rem; }
        .footer-cta .cta-actions { display: flex; gap: .6rem; align-items: center; }
        .footer-cta .btn-cta {
          background-color: #111827; /* near-black from palette */
          color: #fff; border: 0; border-radius: .65rem; padding: .7rem 1rem; font-weight: 700;
          box-shadow: 0 10px 22px -14px rgba(0,0,0,.35);
        }
        .footer-cta .btn-cta:focus { outline: none; box-shadow: 0 0 0 .2rem rgba(var(--accent-yellow-rgb), .4); }
        .footer-cta .btn-cta:hover { filter: brightness(1.05); }
        .footer-cta .btn-cta-outline { background: transparent; color:#fff; border:2px solid rgba(255,255,255,.8); border-radius:.65rem; padding:.66rem 1rem; font-weight:700; }
        .footer-cta .btn-cta-outline:hover { background: rgba(255,255,255,.12); }

        footer.footer-themed { background: linear-gradient(180deg, rgba(var(--primary-blue-rgb),1) 0%, rgba(var(--primary-blue-rgb),.96) 100%); color:#fff; }
        footer.footer-themed .footer-link { color: rgba(255,255,255,.85); text-decoration: none; }
        footer.footer-themed .footer-link:hover, footer.footer-themed .footer-link:focus { color: #fff; text-decoration: underline; }
        footer.footer-themed .footer-title { font-weight: 700; letter-spacing: .2px; color:#fff; }
        footer.footer-themed .footer-sub { color: rgba(255,255,255,.75); }
        footer.footer-themed .social a { display:inline-flex; align-items:center; justify-content:center; width:36px; height:36px; border-radius:999px; background: rgba(var(--secondary-teal-rgb), .18); color:#fff; }
        footer.footer-themed .social a:hover { background: rgba(var(--secondary-teal-rgb), .3); }
        footer.footer-themed .divider { height:1px; background: rgba(255,255,255,.14); margin: 1rem 0; border-radius: 1rem; }
        @media (max-width: 575.98px){ .footer-cta { flex-direction: column; align-items: stretch; } }
      </style>
