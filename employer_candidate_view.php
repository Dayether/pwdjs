...
$userId = $_GET['user_id'] ?? '';
if ($userId === '') {
    Helpers::redirect('employer_candidates.php');
}
...
if (!$cand) {
    Helpers::flash('error', 'Candidate not found.');
    Helpers::redirect('employer_candidates.php');
}
...
$skills = [];
try {
    $experiences = Experience::listByUser($cand['user_id']);
} catch (Throwable $e) {
}
try {
    $certs = Certification::listByUser($cand['user_id']);
} catch (Throwable $e) {
}
try {
    $skills = Skill::getSkillsForUser($cand['user_id']);
} catch (Throwable $e) {
}
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="jsp-summary-card mb-4">
                <div class="jsp-summary-inner p-4">
                    ...
                    <?php endif; ?>
                    <div class="data-grid">
                        <?php if (!empty($cand['email'])): ?><div class="data-item">
                                <div class="label">Email</div>
                                <div class="value"><?php echo htmlspecialchars($cand['email']); ?></div>
                            </div><?php endif; ?>
                        <div class="data-item">
                        ...
                        <?php if ($salaryDisp && $salaryDisp !== 'Unspecified'): ?><div class="data-item">
                                <div class="label">Expected Salary</div>
                                <div class="value"><?php echo htmlspecialchars($salaryDisp); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($cand['interests'])): ?><div class="data-item">
                                <div class="label">Interests</div>
                                <div class="value"><?php echo nl2br(htmlspecialchars($cand['interests'])); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($cand['accessibility_preferences'])): ?><div class="data-item">
                                <div class="label">Accessibility</div>
                                <div class="value"><?php echo htmlspecialchars($cand['accessibility_preferences']); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($cand['preferred_work_setup'])): ?><div class="data-item">
                                <div class="label">Work Setup</div>
                                <div class="value"><?php echo htmlspecialchars($cand['preferred_work_setup']); ?></div>
                            </div><?php endif; ?>
                        <?php if (!empty($cand['preferred_location'])): ?><div class="data-item">
                                <div class="label">Preferred Location</div>
                                <div class="value"><?php echo htmlspecialchars($cand['preferred_location']); ?></div>
                            </div><?php endif; ?>
                        <?php if ($resumeLink): ?><div class="data-item">
                                <div class="label">Resume</div>
                                <div class="value"><a class="text-decoration-none" target="_blank" href="<?php echo $resumeLink; ?>"><i class="bi bi-file-earmark-pdf me-1" aria-hidden="true"></i>View</a></div>
                            </div><?php endif; ?>
                        <?php if ($videoLink): ?><div class="data-item">
                                <div class="label">Video Intro</div>
                                <div class="value"><a class="text-decoration-none" target="_blank" href="<?php echo $videoLink; ?>"><i class="bi bi-camera-video me-1" aria-hidden="true"></i>Watch</a></div>
                            </div><?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-7">
            <div class="section-card p-4 fade-up" role="region" aria-label="Work experience">
                <div class="section-card-header mb-2 d-flex align-items-center"><span class="section-icon me-2"><i class="bi bi-briefcase" aria-hidden="true"></i></span>
            ...
            <div class="section-card p-4 mt-4 fade-up" role="region" aria-label="Certifications">
                <div class="section-card-header mb-2 d-flex align-items-center"><span class="section-icon me-2"><i class="bi bi-patch-check" aria-hidden="true"></i></span>
